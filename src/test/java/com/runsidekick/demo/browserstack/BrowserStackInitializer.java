...
public class BrowserStackInitializer extends ContextInitializedTest {
    ...
    private final String userName = System.getenv("SIDEKICK_BROWSERSTACK_USERNAME");
    private final String accessKey = System.getenv("SIDEKICK_BROWSERSTACK_ACCESSKEY");
